...

{
  ...
  users.users.root.openssh.authorizedKeys.keys = [
    ...
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIEegL8hoUE+rte/7PnivQ7DbgWLy8Pcg8srTcbxlfbke malte@think-top"
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIB9wjlPCEdw5l3emedbuP7/9zqwC8CZHk2Tvs+pN5Ef/ marco@slycro"
  ];
